...
router.put('/increment-num-acc/:eventId', isAuth, isAdmin(2), eventsController.incrementNumAccepted);

router.put('/increment-num-rej/:eventId', isAuth, isAdmin(2), eventsController.incrementNumRejected);

router.put('/increment-num-pendacc/:eventId', isAuth, isAdmin(2), eventsController.incrementNumPendAcc);

router.put('/increment-num-pendrej/:eventId', isAuth, isAdmin(2), eventsController.incrementNumPendRej);
